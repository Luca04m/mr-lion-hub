...
function initLocalStorage() {
  if (!localStorage.getItem(TASKS_KEY) || localStorage.getItem("tasks_reset_v4") !== "1") {
    ...
    localStorage.setItem("tasks_reset_v4", "1");
  }
...
const SEED_CAMPAIGNS: Campaign[] = [
  {
    ...
    checklist: `## 🟠 T-48h (11/03)\n- [x] Revisão Final de Copies — Todos os Canais _(Luca)_\n- [x] Criação dos Roteiros para gravação — 3 Reels MD Chefe _(Guilherme)_\n- [x] Revisão dos Roteiros — MD Chefe _(Luca)_\n- [x] Aprovação dos Roteiros _(Luhan, João, MD)_\n- [x] Criação de 7 Criativos Estáticos + 1 Banner de Site _(Guilherme)_\n- [x] Revisão dos Criativos Estáticos + Banner _(Luca)_\n\n## 🟡 T-24h (12/03) — CRÍTICO\n- [x] **Aprovação Final dos Criativos + Banner** _(Luhan, João, MD)_\n- [ ] **Gravação dos 3 Reels com MD Chefe** _(Luhan, MD)_\n- [ ] **Edição dos 3 Reels — áudio, legendas, trilha, branding** _(Guilherme, Luca)_\n- [ ] **Aprovação Final dos Reels** _(Luhan, João, MD)_\n- [ ] **Configuração da Landing Page com oferta R$99,90** _(Luca)_\n- [x] **Configuração de UTMs de rastreamento** _(Guilherme)_\n- [x] **Setup Meta Ads + Google Ads** _(Guilherme)_\n- [ ] Agendamento de Posts Instagram (Feed + Reels orgânicos) _(Guilherme)_\n\n## 🔴 T-0h (13/03) — Go Live\n- [ ] **Teste Final de Ponta a Ponta — clique → landing → compra** _(Guilherme, Luca)_\n\n## ✅ Checklist Final de Go Live\n- [ ] Preço R$99,90 confere na Landing Page\n- [ ] Landing Page no ar e carregando corretamente\n- [ ] Botão de compra funcionando e direcionando ao checkout\n- [x] Links de anúncios e posts conferem com a Landing Page\n- [ ] Campanhas de Tráfego Pago ativas e veiculando\n- [ ] Posts de Social Media publicados / agendados\n- [x] Públicos de tráfego pago validados\n- [x] Equipe de atendimento ciente e pronta\n- [x] Estoque de Mr. Lion Honey confirmado\n- [x] Remarketing configurado e ativo\n- [x] Criativos corretos e sem erros visuais\n- [x] Textos (copies) sem erros de português\n- [ ] Cronograma de veiculação alinhado com todas as áreas`,
    createdAt: now(),
    updatedAt: now(),
  },
];
...
function initCampaigns() {
  if (!localStorage.getItem(CAMPAIGNS_KEY) || localStorage.getItem("campaigns_reset_v4") !== "1") {
    localStorage.setItem(CAMPAIGNS_KEY, JSON.stringify(SEED_CAMPAIGNS));
    localStorage.setItem("campaigns_reset_v4", "1");
  }
}
